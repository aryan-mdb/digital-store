...
export default function PublicNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-surface-0/85 backdrop-blur-lg">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        <Link to="/" className="flex items-center gap-2 text-lg font-bold text-white" onClick={closeMobile}>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="rounded-lg p-2 text-slate-200 hover:bg-white/10 sm:hidden"
      ...
      {mobileOpen && (
        <div className="border-t border-white/10 bg-surface-0/95 px-4 py-3 sm:hidden">
